...
if (process.env.UNIFORM_API_URL == "[!!! YOUR SITECORE SERVER URL !!!]") {
  missing.push("UNIFORM_API_URL");
}
if (process.env.SITECORE_API_KEY == "[!!! YOUR SITECORE API KEY !!!]") {
  missing.push("SITECORE_API_KEY");
}
if (process.env.UNIFORM_API_TOKEN == "[!!! YOUR UNIFORM API TOKEN FROM SITECORE !!!]") {
  missing.push("UNIFORM_API_TOKEN");
}
